...
class DiarioViewModel: ObservableObject {
    ...
    @Published var emocoes = [
        ...
        Emocao(nome: "Satisfaction", descricao: "Sinto-me grato pelas pessoas e oportunidades na minha vida.", intensidade: 10),
        Emocao(nome: "Reflection", descricao: "Sinto-me desconectado e isolado dos outros.", intensidade: 2)
    ]
}
